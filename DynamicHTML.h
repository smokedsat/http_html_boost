...
{
    std::cout << "generateDynamicResponse function with std::vector<std::string>, std::string,  int" << std::endl;
...
{
    std::cout << "generateDynamicResponse function with Table, std::string, int" << std::endl;
